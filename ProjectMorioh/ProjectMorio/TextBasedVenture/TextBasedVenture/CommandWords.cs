...
namespace TextBasedVentures
{
    public class CommandWords
    {
        ...
        private static Command[] commandArray = { new GoCommand(), new QuitCommand(), new SayCommand(),new NameCommand(), new BackCommand(), new OpenCommand(), new PickupCommand(), new InventoryCommand(), new DropCommand(), new QuestCommand(), new WarpCommand() };
