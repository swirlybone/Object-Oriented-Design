...
namespace StarterGame
{
    public class CommandWords
    {
        ...
        private static Command[] commandArray = { new GoCommand(), new QuitCommand(), new SayCommand(), new StartCommand(),new NameCommand(), new OpenCommand(), new PickupCommand(), new InventoryCommand(), new DropCommand() };
